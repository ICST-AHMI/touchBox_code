...
void setup(){ 
  ...
  writeRegister(DATA_FORMAT, B00000000);
...
void loop(){
  ...
  //x = (int)values[1] & B00000001;
  x = ((((int)values[1]) << 8)|(int)values[0]) + 512;
  ...
  Serial.print(x, BIN);
  Serial.print(',');
  Serial.print((int)values[1], BIN);
  Serial.print(',');
  Serial.println((int)values[0], BIN);
  //Serial.print(y, DEC);
  //Serial.print(',');
